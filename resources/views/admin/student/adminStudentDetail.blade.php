            ...
            <div class="card-body">
                ...
                @if(@$detail->bank)
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <p class="form-control bg-success bg-opacity-10">{{@$detail->bank ? $detail->bank : '-'}}</p>
                        </div>
                    </div>
                @endif
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <p class="form-control bg-success bg-opacity-10">{{@$detail->pengirim ? $detail->pengirim : '-'}}</p>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <p class="form-control bg-success bg-opacity-10">{{@$detail->Instagram ? $detail->Instagram : '-' }}</p>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <p class="form-control bg-success bg-opacity-10">{{@$detail->Line ? $detail->Line : '-'}}</p>
                    </div>
                </div>
